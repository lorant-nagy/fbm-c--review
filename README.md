...
# Results summary
Overall statisticall properties were present, but since a scaling factor was missing in the fft implementation the produced trajectories were off scale.
